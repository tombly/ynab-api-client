...
#pragma warning restore CS8618 // Non-nullable field must contain a non-null value when exiting constructor. Consider declaring as nullable.
    ...
    /// <returns>The list of requested transactions</returns>
    /// <exception cref="ApiException">A server side error occurred.</exception>
    public virtual System.Threading.Tasks.Task<TransactionsResponse> GetTransactionsByMonthAsync(string budget_id, string month, System.DateTimeOffset? since_date, Type? type, long? last_knowledge_of_server)
    {
    ...
    /// <returns>The list of requested transactions</returns>
    /// <exception cref="ApiException">A server side error occurred.</exception>
    public virtual async System.Threading.Tasks.Task<TransactionsResponse> GetTransactionsByMonthAsync(string budget_id, string month, System.DateTimeOffset? since_date, Type? type, long? last_knowledge_of_server, System.Threading.CancellationToken cancellationToken)
    {
        if (budget_id == null)
            throw new System.ArgumentNullException("budget_id");
